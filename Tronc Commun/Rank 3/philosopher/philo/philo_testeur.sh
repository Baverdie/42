...
echo "\033[1;93mNot enough time: \033[0m./philo 2 300 200 300 5 | grep \"died\""
./philo 2 300 200 200 5 | grep "died"
echo "Should \e[1;31mDIE\e[0m"

echo "\033[1;93mNot enough time: \033[0m./philo 4 310 200 100 5 | grep \"died\""
./philo 2 310 200 100 5 | grep "died"
echo "Should \e[1;31mDIE\e[0m"
...
echo "\033[1;93mEating 7 times: \033[0m./philo 5 800 200 200 7 | grep \"died\" | wc -l"
./philo 5 800 200 200 7 > logs/logs_eating7
cat logs/logs_eating7 | grep "died" | wc -l
...
echo "\033[1;93mEVEN philo 10 times:\033[0m./philo 4 410 200 200 7 | grep \"died\" | wc -l"
for i in `seq 1 10`
do
    ./philo 4 410 200 200 7 >> logs/logs_even10
    var=$(cat logs/logs_even10 | grep "died" | wc -l)
    dead=$(($dead + $var))
done
if [ "$dead" = "0" ]
then
echo "\033[1;92mTEST PASS: ${dead}/10 died.\033[0m\n"
else
echo "\033[1;91mTEST FAIL: ${dead}/10 died.\033[0m\n"
fi

dead=0

echo "\033[1;93mODD philo 10 times:\033[0m./philo 5 800 200 200 7 | grep \"died\" | wc -l"
for i in `seq 1 10`
do
    ./philo 5 800 200 200 7 > logs/logs_odd10
    var=$(cat logs/logs_odd10 | grep "died" | wc -l)
    dead=$(($dead + $var))
done
if [ "$dead" = "0" ]
then
